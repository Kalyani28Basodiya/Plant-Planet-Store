...
FrontendAuthDatabasePaymentDeployNext.js 15NextAuth.jsMongoDB AtlasRazorpayVercelTypeScriptJWT SessionsMongoose——Tailwind CSSbcryptjs———TanStack Query————Zustand————
...
bashgit clone https://github.com/Kalyani28Basodiya/Plant-Planet-Store.git
